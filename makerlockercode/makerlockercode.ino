...
const int pwm = 6;
Stepper myStepper(100, 3,2,4,5);       
uchar userCode[50][4] = {{**,**,**,**},   //white
                        {**,**,**,**},   //sf.deng
                        {**,**,**,**},   //yu hui
                        {**,**,**,**},  //ju dalong
                        {**,**,**,**},    //qiang ge
...
void setup() {  
Serial.begin(9600);    
   Serial1.begin(9600);                       // RFID reader SOUT pin connected to Serial RX pin at 2400bps 
...
void loop()
{
	...
	uchar status;
        uchar str[MAX_LEN];
      somebody=digitalRead(9);
      permission=digitalRead(11);
     // if(somebody==1)Serial1.println("people");
...
//			Serial1.println(serNum[3]);
//			Serial1.println(serNum[4]);
//                        Serial1.println(" ");
